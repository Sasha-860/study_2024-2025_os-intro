...
![Задаю имя и email владельца репозитория](image/1.png){#fig:002 width=70%}

Настраиваю utf-8 в выводе сообщений git для их корректного отображения (рис. @fig:003).

![Настройка utf-8 в выводе сообщений git](image/2.png){#fig:003 width=70%}

Начальной ветке задаю имя master (рис. @fig:004).

![Задаю имя начальной ветки](image/3.png){#fig:004 width=70%}

Задаю параметры autocrlf и safecrlf для корректного отображения конца строки (рис. @fig:005).

![Задаю параметры autocrlf и safecrlf](image/4.png){#fig:005 width=70%}

## Создание ключа SSH

Создаю ключ ssh размером 4096 бит по алгоритму rsa (рис. @fig:006).

![Генерация ssh ключа по алгоритму rsa](image/5.png){#fig:006 width=70%}

Создаю ключ ssh по алгоритму ed25519 (рис. @fig:007).

![Генерация ssh ключа по алгоритму ed25519](image/6.png){#fig:007 width=70%}

Нажимаю на “New SSH-key” и вставляю в поле ключ из буфера обмена(рис. @fig:007)

![Добавил ключ ssh](image/7.png){#fig:008 width=70%}
...
![Генерация ключа](image/8.png){#fig:009 width=70%}
...
![Аккаунт на Github](image/9.png){#fig:010 width=70%}
...
![Вывод списка ключей](image/10.png){#fig:011 width=70%}
...
![Копирование ключа в буфер обмена](image/11.png){#fig:012 width=70%}
...
![Добавление нового PGP ключа](image/13.png){#fig:014 width=70%}

Я добавила ключ GPG на GitHub (рис. @fig:015).

![Добавленный ключ GPG](image/14.png){#fig:015 width=70%}
...
![Настройка подписей Git](image/15.png){#fig:016 width=70%}
...
![Создание репозитория](image/19.png){#fig:020 width=70%}
